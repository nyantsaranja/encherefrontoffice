...
export const AuctionsMade = () => {
    ...
    useEffect(() => {
        redirectNotConnected()
            axios.get(`${BASE_URL}/customer/${customerId}/encheres/participation`, CONFIG).then((response) => {
        ...
        <>
            ...
            <div className={"container"}>
                <div className={"col-12"}>
                    <Crud tableTitle={"Liste des enchères auquel vous avez participées"} headers={headers} names={names}
                          rows={auctions}
